...
namespace XNode
{
    ...
    public abstract class Node : ScriptableObject
    {
        ...
        [SerializeField] private NodePortDictionary _ports = new NodePortDictionary();
        ...
        {
            if (_ports.ContainsKey(fieldName)) return _ports[fieldName];
            return null;
        }
        ...
        {
            [SerializeField] private readonly List<string> _keys = new List<string>();
            [SerializeField] private readonly List<NodePort> _values = new List<NodePort>();
