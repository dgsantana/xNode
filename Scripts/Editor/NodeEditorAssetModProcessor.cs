    ...
    internal class NodeEditorAssetModProcessor : UnityEditor.AssetModificationProcessor
    {
        ...
        private static void OnReloadEditor()
        {
            ...
            foreach (var guid in guids)
            {
                ...
                var graph = AssetDatabase.LoadAssetAtPath(assetpath, typeof(XNode.NodeGraph)) as XNode.NodeGraph;
                ...
                {
                    if (!graph.Nodes.Contains(o as XNode.Node)) graph.Nodes.Add(o as XNode.Node);
                }
            }
        }
    }
